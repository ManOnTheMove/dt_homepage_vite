...
import { algoRequirementsTools } from '../config/algoRequirementsTools';
import './HWRequirement.css';

const AlgoRequirements = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Requirements</h1>
      <div className="hero-cards-container">
        {algoRequirementsTools.map((tool) => (
...
export default AlgoRequirements;
