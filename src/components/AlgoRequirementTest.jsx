...
import { algoRequirementTestTools } from '../config/algoRequirementTestTools';
import './HWRequirement.css';

const AlgoRequirementTest = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Requirement Test</h1>
      <div className="hero-cards-container">
        {algoRequirementTestTools.map((tool) => (
...
export default AlgoRequirementTest;
