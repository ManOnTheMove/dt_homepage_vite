...
import { algoImplementationTools } from '../config/algoImplementationTools';
import './HWRequirement.css';

const AlgoImplementation = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      ...
      <div className="hero-cards-container">
        {algoImplementationTools.map((tool) => (
...
export default AlgoImplementation;
