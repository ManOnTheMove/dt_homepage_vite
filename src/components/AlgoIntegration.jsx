...
import { algoIntegrationTools } from '../config/algoIntegrationTools';
import './HWRequirement.css';

const AlgoIntegration = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Integration</h1>
      <div className="hero-cards-container">
        {algoIntegrationTools.map((tool) => (
...
export default AlgoIntegration;
