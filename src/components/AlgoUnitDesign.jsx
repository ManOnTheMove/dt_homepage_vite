...
import { algoUnitDesignTools } from '../config/algoUnitDesignTools';
import './HWRequirement.css';

const AlgoUnitDesign = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Unit Design</h1>
      <div className="hero-cards-container">
        {algoUnitDesignTools.map((tool) => (
