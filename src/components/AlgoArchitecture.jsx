...
import { algoArchitectureTools } from '../config/algoArchitectureTools';
import './HWRequirement.css';

const AlgoArchitecture = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Architecture</h1>
      <div className="hero-cards-container">
        {algoArchitectureTools.map((tool) => (
...
export default AlgoArchitecture;
