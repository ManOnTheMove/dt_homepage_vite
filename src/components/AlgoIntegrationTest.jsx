...
import { algoIntegrationTestTools } from '../config/algoIntegrationTestTools';
import './HWRequirement.css';

const AlgoIntegrationTest = () => {
  // 从URL中提取域名
  ...
  return (
    <div className="hw-requirement-container">
      <h1 className="page-title">Algo Integration test</h1>
      <div className="hero-cards-container">
        {algoIntegrationTestTools.map((tool) => (
...
export default AlgoIntegrationTest;
